...
Sometimes houdini labs doesn't generate the neccessary config files for zbrush GoZ, but this should fix it.
...
4. Make a Polymesh3D and use GoZ in Zbrush and switch to houdini and drop a GoZ import node inside a geo to load the ZBrush model.
